...
import org.springframe.constans.*;
...
public class WXPayUtil {
     ...
     * @return 含有sign字段的XML
     */
    public static String createSignXml(final Map<String, String> data, String key) throws Exception {
        return createSignXml(data, key, SignType.MD5);
    }
     ...
     * @return 含有sign字段的XML
     */
    public static String createSignXml(final Map<String, String> data, String key, SignType signType) throws Exception {
        String sign = createSign(data, key, signType);
    ...
    public static boolean checkSign(String xmlStr, String key) throws Exception {
        ...
        return createSign(data, key).equals(sign);
    }
